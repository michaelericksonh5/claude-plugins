...
Progressive fork note: this copy belongs to `spine-2-0-skills`, forked from `spine-slot-animation` v0.1.3 and branded as Spine 2.0 Skills. The compiler/readiness findings remain inherited unless superseded by fork verification.
